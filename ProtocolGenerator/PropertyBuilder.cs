...
//        builder.AppendLine();
//        AppendLine($"public static Common.PropertyInfo {info.infoName} = classInfo.GetPropertyInfo(\"{info.name}\");", indent);
...
//        AppendLine($"OnPropertyChanged({info.infoName});", indent2);
